...
## Почему воздух и земля обучаются раздельно

У воздуха отдельный checkpoint на 9 коэффициентов трёх PID, у земли — на 15 коэффициентов
пяти PID. Оба SFT-регрессора выдают только `kp/ki/kd`; статический accepted preset остаётся
guard/fallback и не смешивает размерные шкалы воздушного и наземного законов.
"""
