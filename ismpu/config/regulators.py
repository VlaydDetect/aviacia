...
17-мерное действие ниже относится только к изолированному legacy NPGS/PPO. Активный SFT
использует `runtime.sft.GAIN_LAYOUT`: 9 air или 15 ground абсолютных коэффициентов без весов.
...
GainTriplet: TypeAlias = dict[GainKey, float]
GainMap: TypeAlias = dict[RegulatorKey, GainTriplet]
